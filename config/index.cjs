...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx9778edcb2a103ae4',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: 'f5ba592c0c229675c6677464804bf7ee',
  ...
  USERS: [
    {
      ...
      id: 'o8R3X6J0VnwytWIWMQLu_7bBMWg4',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'XqaQ0BK5MmarzY42RfTYNZmHgt-ivozxdKkcBNh7ChE',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '广州',
